...
public class AboutMatchActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   // ActivityAboutMatchTempBinding binding;
    ...
    private void initialization() {
        ...
        Picasso.with(mContext).load(matches.getLocalTeam().getLogo_path()).error(R.drawable.ic_team_placeholder).placeholder(R.drawable.ic_team_placeholder).fit().into(binding.localFlagIcon);
        Picasso.with(mContext).load(matches.getVisitorTeam().getLogo_path()).error(R.drawable.ic_team_placeholder).placeholder(R.drawable.ic_team_placeholder).fit().into(binding.visitorFlagIcon);
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                if (status.equals("success")) {
                                    ...
                                    slidelineList.addAll(emp.getData().getData1().sidelined.slidelineData);
                                    ...
                                    substituteList.addAll(emp.data.data.substitutions.dataSubsti);
                                    if (emp.data.data.localCoach != null && emp.data.data.visitorCoach != null) {
