...
public class PopularListAdapter extends RecyclerView.Adapter<PopularListAdapter.MyviewHolder>  {
    ...
    private LeagueListAdapter.FavoriteUnFavorite listener;

    public PopularListAdapter(Context mContext, List<com.wolfscore.responce.GetLeagueResponce.DataBean.LeagueListBean> leagueList, LeagueListAdapter.FavoriteUnFavorite listener) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                tournamentListFiltered = (ArrayList<com.wolfscore.responce.GetLeagueResponce.DataBean.LeagueListBean>) filterResults.values;
