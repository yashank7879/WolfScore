...
public class LeagueMatchAdapter extends BaseAdapter implements StickyListHeadersAdapter {

    private LayoutInflater inflater;
    ArrayList<Matches> matchesArrayList;
    Context context;
    private Typeface robotoMedium;
    public LeagueMatchAdapter(Context context,   ArrayList<Matches> matchesArrayList) {
    ...
    public long getHeaderId(int position) {
        return matchesArrayList.get(position).getMatchHeader().getId();
    }
