...
public class Config {
  ...
  /*
  *  <color name="home_screen_bg">#1f2024</color>
    <color name="active_text">#ffffff</color>
    <color name="inactive_txt">#8396a5</color>
    <color name="Header_bg">#1e2024</color>
    <color name="list_header_bg">#232d33</color>
    <color name="list_item_bg">#23282c</color>
    <color name="search_bg">#0e0f12</color>
 ...
 */
public static final int CELL_WEEKEND_BACKGROUND = Color.parseColor("#1e2024");
  public static final int CELL_NON_WEEKEND_BACKGROUND =Color.parseColor("#1e2024");
  public static final int CELL_TEXT_CURRENT_MONTH_COLOR =Color.parseColor("#ffffff");
  public static final int CELL_TEXT_ANOTHER_MONTH_COLOR = Color.parseColor("#8396a5");
