...
public class HorizontalExpCalendar extends RelativeLayout implements PageView.PageViewListener, Animations.AnimationsListener {
  ...
  public TextView titleTextView,close_btn;
  ...
  public HorizontalExpCalListener horizontalExpCalListener;
  RelativeLayout relativeLayout;
  private boolean lock;
  Context context;
  public HorizontalExpCalendar(Context context,RelativeLayout relativeLayout) {
    super(context);
      ...
      public void onClick(View view) {
        if (!isLocked()) {
         ...
         /* if (horizontalExpCalListener != null) {
            horizontalExpCalListener.onDateSelected(new DateTime());
          }*/
          unlock();
        }
      }
  ...
  private void refreshTitleTextView() {
   ...
   int month= titleDate.getMonthOfYear();
    String month_name="";
    if (month==1)
      month_name="January";
    if (month==2)
    ...
    titleTextView.setText(month_name);
